...
const BisonCaseStudy = () => {
  return (
    <div className='grid grid-cols-1 gap-10'>
      {/* { first page } */}
      <div className='bg-[#97927C] h-screen flex items-start justify-center'>
        <div className='w-[50vw]'>
        <img
          className="absolute top-[15%] left-[10%] w-[25%] object-contain"
          src="/bisonphone.svg"
          alt="bison"
        />
        </div>
        <div className='w-[50vw] flex flex-col items-center justify-center p-10 space-y-10'>
          <div className='w-[26rem]'>
            <h1 className='font-poppins font-bold text-3xl text-white leading-[1.5]'>
              To make people more aware of how important a bison is in history of American culture 
            </h1>
          </div>
          <div className="grid grid-cols-1 w-[26rem] sm:grid-cols-1 gap-4  max-w-xl">
      ...
      <div className='flex flex-col items-center justify-center p-10 gap-20'>
        <div className="grid grid-cols-1 font-poppins sm:grid-cols-1 gap-10 w-full">
          <div className="text-sm sm:text-lg">
            <strong>Problem Statement:</strong>  People lack awareness about endangered species bisons and need to wait in long queue to get park tickets
          </div>
          <div className="font-poppins text-sm sm:text-lg">
            <strong>Target Audience:</strong> school children, young people between 20-35
          </div>
          <div className="font-poppins text-sm sm:text-lg">
            <strong>Business Goal:</strong> To make more people visit  Yellow stone park to see bisons
          </div>
        </div>
        <div className='grid grid-cols-1 font-poppins sm:grid-cols-1 gap-10 w-full'>
          ...
          <div className='font-poppins text-sm sm:text-lg'>
            The ability to understand someone else’s feelings thoughts in a situation 
          </div>
          <div className='font-poppins text-sm sm:text-lg'>
          In this process many interviews are held so  that we can empathize with users asking many open ended questions. validating their feedback and hypothesis to come with problems faced by the users
          </div>
        </div>
